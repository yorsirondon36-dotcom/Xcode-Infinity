...
function FormasDeGanarPage() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-purple-900 to-purple-950 pb-24">
      ...
      <div className="flex justify-center p-6">
        <img
          src="/whatsapp_image_2026-02-07_at_12.01.31_am.jpeg"
          alt="Reembolso de Tareas"
          className="w-11/12 h-auto rounded-xl shadow-lg"
        />
      </div>
      ...
      <div className="flex justify-center p-6">
        <img
          src="/whatsapp_image_2026-02-07_at_12.10.02_am.jpeg"
          alt="Reglas de Recompensas por Invitación"
          className="w-11/12 h-auto rounded-xl shadow-lg"
        />
      </div>
