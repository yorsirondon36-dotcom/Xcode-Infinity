    ...
    <div className="min-h-screen bg-gradient-to-b from-purple-900 to-purple-950 pb-24">
      ...
      <div className="p-6">
        <div className="bg-purple-800 rounded-xl p-6 shadow-md border border-purple-700">
          <h2 className="text-xl font-bold text-yellow-400 mb-4">Múltiples Formas de Ganar</h2>
          <p className="text-purple-200 text-base leading-relaxed">
            Descubre las diferentes formas de ganar dinero en nuestra plataforma. Desde recargas, retiros, hasta comisiones por tu equipo.
          </p>
        </div>
      </div>
