/*
  # Actualizar porcentaje de comisión Nivel 1 por compra de niveles

  Cambio en la comisión por compra de niveles:
  - Nivel 1 (Directo): de 20% a 12%
...
BEGIN
  ...
  FOR v_referrer_level IN 1..3 LOOP
    ...
    v_commission_rate := CASE 
      WHEN v_referrer_level = 1 THEN 0.12
